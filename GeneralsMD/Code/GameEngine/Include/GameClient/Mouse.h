...
public:
	...
	enum MouseCursor
	{
		...
		POWER_ON,
		POWER_OFF,
		DISGUISE_AS_INFANTRY,
		DISGUISE_AS_OBJECT,
		DISGUISE_AS_ENVIRONMENT,
		EQUIP_OBJECT,
		GARRISON_CLEAR,
		CHRONO_OBJECT,
		CHRONO_MOVE,
		...
		ATTACKMOVETO_ALT,
		ATTACK_OBJECT_ALT,
		FORCE_ATTACK_OBJECT_ALT,
		FORCE_ATTACK_GROUND_ALT,
		BUILD_PLACEMENT_ALT,
		INVALID_BUILD_PLACEMENT_ALT,
		GENERIC_INVALID_ALT,
		SELECTING_ALT,
		ENTER_FRIENDLY_ALT,
		ENTER_AGGRESSIVELY_ALT,
		SET_RALLY_POINT_ALT,
		...
		ATTACKMOVETO_ALT2,
		ATTACK_OBJECT_ALT2,
		FORCE_ATTACK_OBJECT_ALT2,
		FORCE_ATTACK_GROUND_ALT2,
		BUILD_PLACEMENT_ALT2,
		INVALID_BUILD_PLACEMENT_ALT2,
		GENERIC_INVALID_ALT2,
		SELECTING_ALT2,
		ENTER_FRIENDLY_ALT2,

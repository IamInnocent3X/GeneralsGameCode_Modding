...
//*********************************************************************************************************
	...
	OrderNearbyData getOrderNearbyData() const { return m_orderData; }
	ObjectID getDoSingleID() const { return m_doSingleID; }
	Bool getDoSingleAddStat() const { return m_doSingleAddStat; }

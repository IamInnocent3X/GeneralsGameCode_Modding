...
public:
    ...
    UpdateModuleData::buildFieldParse(p);
		static const FieldParse dataFieldParse[] =
		{
			...
			{ "BomberGetsExperienceOnKill",		INI::parseBool,					NULL, offsetof( StickyBombUpdateModuleData, m_bomberGetsExperienceOnKill ) },
			{ "DoSabotageOnDetonate",		INI::parseBool,					NULL, offsetof( StickyBombUpdateModuleData, m_doSabotageOnDetonate ) },
			{ 0, 0, 0, 0 }
		};

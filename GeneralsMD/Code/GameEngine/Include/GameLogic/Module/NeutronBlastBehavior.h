...
public:
	...
	static void buildFieldParse( MultiIniFieldParse& p )
	{
		...
		static const FieldParse dataFieldParse[] =
		{
			...
			{ "KindOf", KindOfMaskType::parseFromINI, nullptr, offsetof( NeutronBlastBehaviorModuleData, m_kindOf ) },
			{ "ForbiddenKindOf", KindOfMaskType::parseFromINI, nullptr, offsetof( NeutronBlastBehaviorModuleData, m_forbiddenKindOf ) },
			{ "KindOfToKill", KindOfMaskType::parseFromINI, nullptr, offsetof( NeutronBlastBehaviorModuleData, m_kindOfToKill ) },
			{ "KindOfToKillContained", KindOfMaskType::parseFromINI, nullptr, offsetof( NeutronBlastBehaviorModuleData, m_kindOfToKillContained ) },
			{ 0, 0, 0, 0 }
		};

...
public:
	...
	virtual const AsciiString& getCursorName() const override { return getChronoSphereUpdateModuleData()->m_cursorName; }
	...
	virtual Bool doesSpecialPowerHaveOverridableDestinationActive() const override { return m_active; }

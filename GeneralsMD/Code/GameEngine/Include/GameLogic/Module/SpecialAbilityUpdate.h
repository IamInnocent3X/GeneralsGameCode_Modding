  ...
  const ObjectCreationList *m_oclOnExecute;
    ...
    UpdateModuleData::buildFieldParse(p);
      ...
      { "PersistenceRequiresRecharge",INI::parseBool,										NULL, offsetof( SpecialAbilityUpdateModuleData, m_persistenceRequiresRecharge ) },
			...
			{ "DisabledType",	DisabledMaskType::parseSingleBitFromINI, NULL, offsetof( SpecialAbilityUpdateModuleData, m_disabledType ) },
			{ "UseSabotageBehavior",				INI::parseBool,					NULL, offsetof( SpecialAbilityUpdateModuleData, m_useSabotageBehavior ) },
			{ "CanHackOrCaptureAirborneTargets",	INI::parseBool,					NULL, offsetof( SpecialAbilityUpdateModuleData, m_canHackOrCaptureAirborneTargets ) },

...
//-------------------------------------------------------------------------------------------------
class SabotageSupplyDropzoneCrateCollideModuleData : public SabotageBehaviorModuleData
{
public:
	...
	SabotageSupplyDropzoneCrateCollideModuleData()
	{
		...
		m_sabotageType = SABOTAGE_CASH | SABOTAGE_SPECIAL_POWER;
		m_feedbackType = SAB_VICTIM_DROP_ZONE;
		m_sabotageResetOCLUpdate = TRUE;
		m_kindof.clear();
		m_kindof.set(KINDOF_FS_SUPPLY_DROPZONE);
	}
    ...
    SabotageBehaviorModuleData::buildFieldParse(p);
		...
		{
			//{ "StealCashAmount",	INI::parseUnsignedInt, nullptr, offsetof( SabotageSupplyDropzoneCrateCollideModuleData, m_stealCashAmount ) },
			{ 0, 0, 0, 0 }
		};
...
//-------------------------------------------------------------------------------------------------
class SabotageSupplyDropzoneCrateCollide : public SabotageBehavior
{

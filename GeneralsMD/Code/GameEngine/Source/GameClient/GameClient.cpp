...
void GameClient::iterateDrawablesInRegion( Region3D *region, GameClientFuncPtr userFunc, void *userData )
{
	...
	// IamInnocent - 1/1/26 Added More Efficient Form of IterateDrawablesInRegion that does not Iterate Through Every Drawable present in the Map
	...
	//// In worse conditions, 8 player maps, around 150-200.
#if !RETAIL_COMPATIBLE_DRAWUPDATE

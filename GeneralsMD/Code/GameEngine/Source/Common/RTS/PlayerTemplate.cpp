...
/*static*/ const FieldParse* PlayerTemplate::getFieldParse()
{
    ...
    { "OldFaction",               INI::parseBool,                                 nullptr, offsetof( PlayerTemplate, m_oldFaction ) },
		{ "RandomableForAI",               				INI::parseBool,                                 			nullptr, offsetof( PlayerTemplate, m_randomableForAI ) },
		...
		{ "SelectingCursorName",				INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_selectingCursorName ) },
		{ "ArrowCursorName",					INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_arrowCursorName ) },
		{ "ScrollCursorName",					INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_scrollCursorName ) },
		{ "MoveCursorName",						INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_moveToCursorName ) },
		{ "MoveInFormationCursorName",			INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_moveInFormationToCursorName ) },
		{ "AttackMoveCursorName",				INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_attackMoveToCursorName ) },
		{ "WaypointCursorName",					INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_waypointCursorName ) },
		{ "GenericInvalidCursorName",			INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_genericInvalidCursorName ) },
		{ "EnterCursorName",					INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_enterCursorName ) },
		{ "EnterAggressiveCursorName",			INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_enterAggressiveCursorName ) },
		{ "TargetCursorName",					INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_targetCursorName ) },
		{ "AttackCursorName",					INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_attackObjectCursorName ) },
		{ "ForceAttackCursorName",				INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_forceAttackObjectCursorName ) },
		{ "ForceAttackGroundCursorName",		INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_forceAttackGroundCursorName ) },
		{ "OutrangeCursorName",					INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_outrangeCursorName ) },
		{ "GetRepairAtCursorName",				INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_getRepairAtCursorName ) },
		{ "DockCursorName",						INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_dockCursorName ) },
		{ "GetHealedCursorName",				INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_getHealedCursorName ) },
		...
		{ "SmartGarrisonCursorName",			INI::parseAsciiString,													nullptr, offsetof( PlayerTemplate, m_smartGarrisonCursorName ) },

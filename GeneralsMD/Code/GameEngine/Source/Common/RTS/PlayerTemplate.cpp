...
/*static*/ const FieldParse* PlayerTemplate::getFieldParse()
{
    ...
    { "OldFaction",               INI::parseBool,                                 NULL, offsetof( PlayerTemplate, m_oldFaction ) },
		{ "RandomableForAI",               				INI::parseBool,                                 			NULL, offsetof( PlayerTemplate, m_randomableForAI ) },
		...
		{ "SelectingCursorName",				INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_selectingCursorName ) },
		...
		{ "EnterCursorName",					INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_enterCursorName ) },
		{ "EnterAggressiveCursorName",			INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_enterAggressiveCursorName ) },
		{ "TargetCursorName",					INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_targetCursorName ) },
		{ "AttackCursorName",					INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_attackObjectCursorName ) },
		{ "ForceAttackCursorName",				INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_forceAttackObjectCursorName ) },
		{ "ForceAttackGroundCursorName",		INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_forceAttackGroundCursorName ) },
		{ "OutrangeCursorName",					INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_outrangeCursorName ) },
		{ "GetRepairAtCursorName",				INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_getRepairAtCursorName ) },
		{ "DockCursorName",						INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_dockCursorName ) },
		{ "GetHealedCursorName",				INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_getHealedCursorName ) },
		{ "DoRepairCursorName",					INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_doRepairCursorName ) },
		{ "ResumeConstructionCursorName",		INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_resumeConstructionCursorName ) },
		{ "SetRallyPointCursorName",			INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_setRallyPointCursorName ) },
		{ "BuildCursorName",					INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_buildCursorName ) },
		{ "InvalidBuildCursorName",				INI::parseAsciiString,													NULL, offsetof( PlayerTemplate, m_invalidBuildCursorName ) },

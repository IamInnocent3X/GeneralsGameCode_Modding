...
)
{
	...
	if( polarity_dx == polarity_dx2 && polarity_dy == polarity_dy2 )
	{
		...
		//DEBUG_LOG(("Distance for second Min point chosen - %d: %f.", secondMinIdx, secondMinDist));
	}
	...
	Real distBoundarySqr = sqr_boundary_2 - sqr(boundary_h1);

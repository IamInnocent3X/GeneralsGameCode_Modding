...
static Object *findObjectToRepair( Object *dozer )
{
	...
	PartitionFilter *filters[] = { &filter1, &filterMapStatus, NULL };
...
void DozerAIUpdateModuleData::buildFieldParse( MultiIniFieldParse& p)
{
  AIUpdateModuleData::buildFieldParse( p );
	...
	static const FieldParse dataFieldParse[] =
	{
		...
		{ "RepairKindOf",	KindOfMaskType::parseFromINI,	NULL, offsetof( DozerAIUpdateModuleData, m_kindOf ) },
		{ "RepairForbiddenKindOf",	KindOfMaskType::parseFromINI,	NULL, offsetof( DozerAIUpdateModuleData, m_forbiddenKindOf ) },

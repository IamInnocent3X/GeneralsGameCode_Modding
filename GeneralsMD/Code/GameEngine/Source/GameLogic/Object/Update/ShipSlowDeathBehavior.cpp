...
ShipSlowDeathBehaviorModuleData::ShipSlowDeathBehaviorModuleData( void )
{
	...
	m_fxStartTopple = nullptr;
	m_oclStartTopple = nullptr;
	m_fxStartSink = nullptr;
	m_oclStartSink = nullptr;
	//m_toppleDamping = 1.0;
...
/*static*/ void ShipSlowDeathBehaviorModuleData::buildFieldParse( MultiIniFieldParse &p )
{
  SlowDeathBehaviorModuleData::buildFieldParse( p );
	...
	{
		{ "InitialDelay", INI::parseDurationUnsignedInt, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_initialDelay) },
		{ "InitialDelayVariance", INI::parseDurationUnsignedInt, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_initialDelayVariance) },
		{ "InitialConditionFlag",	ModelConditionFlags::parseSingleBitFromINI,	nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_conditionFlagInit) },

		{ "WobbleMaxAnglePitch", INI::parseAngleReal, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_wobbleMaxPitch) },
		{ "WobbleMaxAngleYaw", INI::parseAngleReal, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_wobbleMaxYaw) },
		{ "WobbleMaxAngleRoll", INI::parseAngleReal, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_wobbleMaxRoll) },
		{ "WobbleInterval", INI::parseDurationUnsignedInt, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_wobbleInterval) },

		{ "ToppleStyle", INI::parseIndexList, TheShipToppleNames, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleType) },
		{ "ToppleFrontMinPitch", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleFrontMinPitch) },
		{ "ToppleFrontMaxPitch", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleFrontMaxPitch) },
		{ "ToppleBackMinPitch", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleBackMinPitch) },
		{ "ToppleBackMaxPitch", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleBackMaxPitch) },
		{ "ToppleSideMinRoll", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleSideMinRoll) },
		{ "ToppleSideMaxRoll", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleSideMaxRoll) },
		{ "ToppleMinHeightOffset", INI::parseReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleHeightMinOffset) },
		{ "ToppleMaxHeightOffset", INI::parseReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleHeightMaxOffset) },
		{ "ToppleDuration", INI::parseDurationUnsignedInt, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleDuration) },
		{ "ToppleDurationVariance", INI::parseDurationUnsignedInt, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleDurationVariance) },

		{ "ToppleMinPushForce", INI::parseReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleMinPushForce) },
		{ "ToppleMaxPushForce", INI::parseReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleMaxPushForce) },
		{ "ToppleMinPushForceSide", INI::parseReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleMinPushForceSide) },
		{ "ToppleMaxPushForceSide", INI::parseReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleMaxPushForceSide) },
		{ "ToppleConditionFlag",	ModelConditionFlags::parseSingleBitFromINI,	nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_conditionFlagTopple) },


		{ "FXStartTopple", INI::parseFXList, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_fxStartTopple) },
		{ "OCLStartTopple", INI::parseObjectCreationList, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_oclStartTopple) },

		//{ "ToppleDampingDuration", INI::parseDurationUnsignedInt, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleDampingDuration) },
		//{ "ToppleDamping", INI::parseReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleDamping) },
		{ "ToppleAngleCorrectionRate", INI::parseAngularVelocityReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_toppleAngleCorrectionRate) },

		//{ "SinkWobbleMaxAnglePitch", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_sinkWobbleMaxPitch) },
		//{ "SinkWobbleMaxAngleYaw", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_sinkWobbleMaxYaw) },
		//{ "SinkWobbleMaxAngleRoll", INI::parseAngleReal, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_sinkWobbleMaxRoll) },
		//{ "SinkWobbleInterval", INI::parseDurationUnsignedInt, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_sinkWobbleInterval) },
		{ "SinkHowFast", INI::parsePercentToReal, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_sinkHowFast) },
		{ "FXStartSink", INI::parseFXList, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_fxStartSink) },
		{ "OCLStartSink", INI::parseObjectCreationList, nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_oclStartSink) },
		{ "SinkConditionFlag",	ModelConditionFlags::parseSingleBitFromINI,	nullptr, offsetof(ShipSlowDeathBehaviorModuleData, m_conditionFlagSink) },

		{ "SinkAttachParticle", INI::parseParticleSystemTemplate, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_attachParticleSystem ) },
		{ "SinkAttachParticleBones", INI::parseAsciiStringVector, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_attachParticleBoneNames ) },

		{ "OCLEjectPilot", INI::parseObjectCreationList, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_oclEjectPilot ) },
		
		{ "FXHitGround", INI::parseFXList, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_fxHitGround ) },
		{ "OCLHitGround", INI::parseObjectCreationList, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_oclHitGround ) },
		
		{ "SoundSinkLoop", INI::parseAudioEventRTS, nullptr, offsetof( ShipSlowDeathBehaviorModuleData, m_deathSound) },
...
/// @todo srj use SLEEPY_UPDATE here
	...
	if (obj->getHeightAboveTerrain() <= 1.0) {
		...
		ObjectCreationList::create(d->m_oclHitGround, obj, nullptr);
...
void ShipSlowDeathBehavior::beginTopplePhase()
{
	...
	ObjectCreationList::create(d->m_oclStartTopple, obj, nullptr);
		...
		if (d->m_attachParticleSystem)
		{
			...
			if (d->m_attachParticleBoneNames.empty()) {
				...
				for (AsciiString boneName : d->m_attachParticleBoneNames) {
					ParticleSystem* pSys = TheParticleSystemManager->createParticleSystem(d->m_attachParticleSystem);
					if (pSys) {
						if (draw->getPristineBonePositions(boneName.str(), 0, &pos, nullptr, 1))

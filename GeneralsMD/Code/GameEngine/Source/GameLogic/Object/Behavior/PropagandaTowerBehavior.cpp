...
/*static*/ void PropagandaTowerBehaviorModuleData::buildFieldParse( MultiIniFieldParse &p )
{
  UpdateModuleData::buildFieldParse( p );
	...
	static const FieldParse dataFieldParse[] =
	{
		...
		{ "HealingClearsParasite",			INI::parseBool,	nullptr, offsetof( PropagandaTowerBehaviorModuleData, m_autoHealClearsParasite ) },
		{ "HealingClearsParasiteKeys",		INI::parseAsciiStringVector, nullptr, offsetof( PropagandaTowerBehaviorModuleData, m_autoHealClearsParasiteKeys ) },
																					 ...
																					 const PropagandaTowerBehaviorModuleData *modData )
{
	...
	if( giving )
	{
		...
		if( body )
		{
			...
			Real amount = healthPercent / static_cast<float>(LOGICFRAMES_PER_SECOND) * body->getMaxHealth();

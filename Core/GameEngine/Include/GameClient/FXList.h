...
public:
	...
	*/
	virtual void doFXPos(const Coord3D *primary, const Matrix3D* primaryMtx = nullptr, const Real primarySpeed = 0.0f, const Coord3D *secondary = nullptr, const Real overrideRadius = 0.0f, FXSurfaceInfo* surfaceInfo = nullptr) const = 0;

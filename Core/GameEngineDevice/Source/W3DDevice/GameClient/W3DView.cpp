...
//					Real ratio = 1.0f - snapThreshSqr/curDistSqr;
  ...
  TheTerrainVisual->updateSeismicSimulations();
	...
	//// IamInnocent 1/1/26 - Implemented an Efficient Drawable Iteration Function for Drawables Under Screen Region
#if !RETAIL_COMPATIBLE_DRAWUPDATE
...
#if !RETAIL_COMPATIBLE_DRAWUPDATE
	// IamInnocent 6/10/2025 - Uses Partition Manager to find Drawables that fits onto the region.

...
public:
	...
	void breakTrack();	///< end current strip (last edge feathered) so the next edge starts a fresh, unconnected anchor (teleport - keeps existing edges, no bridging quad)
